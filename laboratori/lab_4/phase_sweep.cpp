...
void phase_sweep()
{
  ...
  TPad *padOffset = new TPad("padOffset", "Offset", 0.5, 0., 1., 1., kWhite);
  padFit->Draw();
  padOffset->Draw();
  ...
  legend->AddEntry(graphResistenza, "Fase resistenza");
  legend->AddEntry(graphInduttanza, "Fase induttanza");
  legend->AddEntry(graphCondensatore, "Fase condensatore");
